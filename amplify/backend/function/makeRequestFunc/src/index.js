...
var EcstaticVoiceOfTheTribe_botAPIKEY = process.env
    .ECSTATICVOICEOFTHETRIBE_BOTAPIKEY;
var chatIds = [
...
var handler = function (event, context, callback) { return __awaiter(void 0, void 0, void 0, function () {
    var _i, chatIds_1, chatId, msTp, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                msTp = messages_1.MessageTypes[event.key1];
                _a.label = 2;
            case 2:
                _a.trys.push([2, 4, , 5]);
                return [4 /*yield*/, axios_1["default"].post("https://api.telegram.org/bot".concat(EcstaticVoiceOfTheTribe_botAPIKEY, "/sendMessage"), {
                        chat_id: chatId,
                        text: messages_1.MessagesDict[msTp]
                    })];
            case 3:
                _a.sent();
                return [3 /*break*/, 5];
